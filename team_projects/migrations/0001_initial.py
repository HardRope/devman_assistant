    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('briefing', models.URLField(verbose_name='Ссылка на бриф')),
                ...
                ('available_timecodes', models.ManyToManyField(related_name='projects', to='team_projects.availabletimecode', verbose_name='Таймкоды созвона')),
        ...
        migrations.AddField(
            model_name='project',
            name='students',
            field=models.ManyToManyField(related_name='projects', to='team_projects.student', verbose_name='Участники'),
        ),
        migrations.AddField(
            model_name='group',
            name='project',
        ...
        migrations.AddField(
            model_name='group',
            name='timecode',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='groups', to='team_projects.availabletimecode', verbose_name='Время созвона'),
        ),
    ]
